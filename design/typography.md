...
1. **نیم‌فاصله / ZWNJ (U+200C) is mandatory.** Use it in prefixes/suffixes and compounds: «می‌خواهم»، «فولادنو»، «خانه‌ها»، «به‌روزرسانی»، «قیمت‌ها». Content pipeline and the AI output must insert correct ZWNJ. **Never** a full space where a half-space belongs.
...
```
display   فولادنو، مشاور هوشمند خرید آهن و فولاد            (Estedad 800/40)
h1        قیمت میلگرد امروز                                  (700/32)
h2        چرا فولادنو؟                                       (700/26)
