...
### Principles (POUR)
Perceivable · Operable · Understandable · Robust. Plus a Ahantime-specific lever: **the AI advisor «آهن‌تایم» is an accessibility feature** — it lets users who struggle with tables, jargon, or typing get prices and estimates conversationally.
...
- **Messages:** user vs آهن‌تایم visually + semantically distinguished (e.g., prefix/`aria-label`).
