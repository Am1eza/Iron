# Ahantime — Empty, Zero & Error States
...
### Principles
1. **No dead-ends.** Every empty/error/stale view offers a way forward — usually **«ثبت درخواست»** or **«پرسش از آهن‌تایم»** or **retry**.
...
│   [ اقدام دوم ]  ·  «پرسش از آهن‌تایم» │  ← optional secondary / AI
└───────────────────────────────┘
```
...
|---|---|---|---|---|---|
| **Price table — filter no-results** | no-results | «موردی پیدا نشد» | با این فیلترها محصولی نیست. فیلترها رو ساده‌تر کنید یا از آهن‌تایم بپرسید. | **حذف فیلترها** | *پرسش از آهن‌تایم* |
...
| **Site search — no results** | no-results | «چیزی پیدا نشد» | برای «{q}» نتیجه‌ای نبود. املا رو بررسی کنید یا از آهن‌تایم بپرسید. | **پرسش از آهن‌تایم** | *مشاهدهٔ دسته‌ها* |
...
| **Requests/history — empty** | first-use | «هنوز درخواستی ثبت نکردید» | از جدول قیمت یا آهن‌تایم، درخواست بدید تا اینجا پیگیری کنید. | **مشاهدهٔ قیمت‌ها** | *پرسش از آهن‌تایم* |
...
| **Inquiry cart — empty** | cleared | «سبد استعلام خالیه» | محصول‌ها رو به سبد اضافه کنید تا یک‌جا پیش‌فاکتور بگیرید. | **بازگشت به قیمت‌ها** | *پرسش از آهن‌تایم* |
| **Account — first visit** | first-use | «به آهن‌تایم خوش اومدید» | قیمت‌ها رو ببینید، هشدار بذارید و درخواست بدید. | **مشاهدهٔ قیمت‌ها** | *عضویت در باشگاه* |
| **Club — not a member** | first-use | «باشگاه آهن‌تایم» | با عضویت، قیمت ویژه، تحویل اولویت‌دار و مشاور اختصاصی بگیرید. | **عضویت** | *بیشتر بدونید* |
...
| **404** | not-found | «این صفحه پیدا نشد» | شاید آدرس عوض شده. از جستجو یا آهن‌تایم کمک بگیرید. | **بازگشت به خانه** | *جستجو · دسته‌های پرطرفدار · پرسش از آهن‌تایم* |
