...
export const marketValues: MarketValue[] = [
  { key: 'usd', label: 'دلار', value: 82350, unit: 'تومان', source: 'tgju', movementDir: 'up', movementPct: 0.4, updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  { key: 'eur', label: 'یورو', value: 89100, unit: 'تومان', source: 'tgju', movementDir: 'up', movementPct: 0.3, updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  { key: 'gold18', label: 'طلای ۱۸', value: 3850000, unit: 'تومان', source: 'tgju', movementDir: 'down', movementPct: -0.2, updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  { key: 'ounce', label: 'انس جهانی', value: 2380, unit: 'دلار', source: 'tgju', movementDir: 'up', movementPct: 0.1, updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  { key: 'billet', label: 'شمش فولاد', value: 285000, unit: 'تومان', source: 'admin', movementDir: 'up', movementPct: 0.6, updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
];
...
export const rebarRows: PriceRow[] = [
  {
    ...
    current: { skuId: 's1', price: 32450, unit: 'kg', deliveryTime: '۲۴ ساعت', vatIncluded: false, movementPct: 0.8, movementDir: 'up', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
  {
    ...
    current: { skuId: 's2', price: 32100, unit: 'kg', deliveryTime: '۴۸ ساعت', vatIncluded: false, movementPct: -0.3, movementDir: 'down', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
  {
    ...
    current: { skuId: 's3', price: 31950, unit: 'kg', deliveryTime: '۲۴ ساعت', vatIncluded: false, movementPct: 0.5, movementDir: 'up', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
  {
    ...
    current: { skuId: 's4', price: 32600, unit: 'kg', deliveryTime: '۲۴ ساعت', vatIncluded: false, movementPct: 1.2, movementDir: 'up', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
  {
    ...
    current: { skuId: 's5', price: 31800, unit: 'kg', deliveryTime: '۷۲ ساعت', vatIncluded: false, movementPct: 0, movementDir: 'flat', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
  {
    ...
    current: { skuId: 's6', price: 33150, unit: 'kg', deliveryTime: '۲۴ ساعت', vatIncluded: false, movementPct: -0.6, movementDir: 'down', updatedAt: '2026-06-29T08:00:00.000Z', isStale: false },
  },
];
