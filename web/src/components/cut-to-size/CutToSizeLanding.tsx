...
import { CutToSizeForm } from './CutToSizeForm';

const BENEFIT_KEYS = ['exactSize', 'lessWaste', 'precisionCut', 'readyToDeliver'] as const;
const STEP_KEYS = ['register', 'reviewAndQuote', 'cutting', 'delivery'] as const;

/**
 * The cut-to-size landing's translatable body — marketing copy, benefits,
 * steps and the request form. Split out of `cut-to-size/page.tsx` (a Server
 ...
 */
export function CutToSizeLanding() {
  const t = useTranslations('cutToSizePage');
