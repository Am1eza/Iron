...
/** «چرا فولادنو» — the four trust pillars (vision/brand). Calm, no hype. */
const PILLARS = [
  {
    Icon: SparkIcon,
    accent: 'ai',
    title: 'مشاور هوشمند، نه فروشندهٔ پرحرف',
    text: 'فولادنو متراژ پروژه‌ات را می‌فهمد و بر پایهٔ قیمت‌های واقعی راهنمایی می‌کند — بدون عدد ساختگی.',
  },
  {
    Icon: TagIcon,
    accent: 'action',
  ...
  return (
    <section className={styles.section} aria-labelledby="why-title">
      ...
      <div className={styles.head}>
        <p className={styles.eyebrow}>چرا فولادنو</p>
