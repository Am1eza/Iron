# Fooladno Web — Frontend Architecture & Project Structure
...
**Purpose:** Lock the stack, the folder structure, and the conventions for building the Fooladno **website** — so every later section (components, pages, AI, admin) drops into a clean, scalable foundation.
