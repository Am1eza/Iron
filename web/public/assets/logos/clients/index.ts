...
export const clientLogos: ClientLogo[] = [
  ...
  { slug: 'pars-garma', name: 'Pars Garma', nameFa: 'پارس گرما', website: 'https://parsgarma.com', file: '/assets/logos/clients/pars-garma.png', hasLogo: true, monogram: 'PG' },
  { slug: 'pgpic', name: 'Persian Gulf Petrochemical Industries Company', nameFa: 'صنایع پتروشیمی خلیج فارس', website: 'https://pgpic.ir', file: '/assets/logos/clients/pgpic.svg', hasLogo: false, monogram: 'PGPIC' },
  { slug: 'azarab', name: 'Azarab', nameFa: 'آذرآب', website: 'http://www.azarab.ir', file: '/assets/logos/clients/azarab.svg', hasLogo: false, monogram: 'AZ' },
  ...
  { slug: 'mapna-pars', name: 'MAPNA Pars Generator Engineering & Manufacturing', nameFa: 'مهندسی و ساخت ژنراتور مپنا (پارس)', website: 'https://mapnagroup.com/mapnacompanies/mapna-pars', file: '/assets/logos/clients/mapna-pars.svg', hasLogo: false, monogram: 'MAPNA' },
