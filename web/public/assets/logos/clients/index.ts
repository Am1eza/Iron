...
export const clientLogos: ClientLogo[] = [
  ...
  { slug: 'pgpic', name: 'Persian Gulf Petrochemical Industries Company', nameFa: 'صنایع پتروشیمی خلیج فارس', website: 'https://pgpic.ir', file: '/assets/logos/clients/pgpic.png', hasLogo: true, monogram: 'PGPIC' },
  { slug: 'azarab', name: 'Azarab', nameFa: 'صنایع آذرآب', website: 'http://www.azarab.ir', file: '/assets/logos/clients/azarab.png', hasLogo: true, monogram: 'AZ' },
  ...
  { slug: 'mapna-pars', name: 'MAPNA Pars Generator Engineering & Manufacturing', nameFa: 'مپنا پارس', website: 'https://mapnagroup.com/mapnacompanies/mapna-pars', file: '/assets/logos/clients/mapna-pars.png', hasLogo: true, monogram: 'MAPNA' },
