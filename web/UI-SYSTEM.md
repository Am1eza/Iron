# Fooladno — Phase 3 · UI Engineering
...
- **No dead-ends.** `EmptyState` + `emptyPresets` make every "nothing here" a funnel moment (request / browse / ask فولادنو) with on-brand Persian copy.
