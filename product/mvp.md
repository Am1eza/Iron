# Poladin — MVP Definition
## Layer 2 · Product Design — Document 2 of N

**Version:** 1.0 · 26 June 2026
**Status:** Draft for approval
**Builds on:** `product/product-scope.md` (v1.0)
**Scope of this document:** Defines the **Minimum Viable Product** — the smallest launchable version of the Poladin **website** that proves the core loop and is genuinely useful and differentiated. It states precisely what is **in the MVP**, what is **deferred (fast-follow)**, and what is **hard-excluded**, each with rationale and acceptance criteria.
...
نبض بازار ticker / SEO price page  ──►  Visitor lands
        ...
        Right-side category rail                          AI hero «پولادین»
...
### M4 · AI Advisor «پولادین» (focused MVP)
**Includes**
...
| **v1.2** | **Customer club (باشگاه پولادین)** + intent popup | Needs benefit machinery & tiers; not required to validate hypotheses. |
