...
## EPIC D — AI Advisor «فولادنو» (critical)
...
- AC1: The homepage shows a central rectangle/search hero with a greeting (e.g., «سلام، من فولادنوم. چه محصولی می‌خواید بخرید؟»).
...
## EPIC H — Customer Club «باشگاه فولادنو»
...
**US-J1** — *As P2 (Builder), I want a clear «چرا فولادنو؟», so that I understand why to trust/choose you.*
