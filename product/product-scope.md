...
- **Club member (باشگاه پولادین):** a registered user enrolled in the loyalty club; receives tiered benefits.
...
- **«چرا پولادین؟» (Why us)** — competitive advantages (cheaper, faster, AI advisor, transparent prices, guaranteed delivery, expert support).
...
### C. AI Advisor — «پولادین»
- **Central AI search hero** ("سلام، من پولادینم. چه محصولی می‌خواید بخرید؟") — **clearly an AI**, with greeting and suggested-question chips.
...
### G. Customer Club — «باشگاه پولادین»
...
- **Two-sided open marketplace / third-party sellers** — Poladin curates its own catalog/prices (the «تأمین از شما» track is a lead form, not a seller portal, in Phase 1).
