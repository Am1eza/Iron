...
- **Entry mode:** **Guided lane** — AI advisor «آهن‌تایم» (intent-first) + پروژه‌سنج + وزن‌سنج.
...
- **Context:** Wants to sell supply to/through Ahantime («تأمین از شما»).
